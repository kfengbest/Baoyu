...
#import "MyFavoriesViewController.h"

@interface MyFavoriesViewController ()

@end

@implementation MyFavoriesViewController
...
{
    static NSString* MyCellID = @"MyFavoriteCell";
